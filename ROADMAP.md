...
## 9. آخر تحديث نمو في Play Console — 2026-09-20

تم تغيير التصنيف من **Productivity** إلى **Tools**، وتقليص الوسوم إلى **Privacy & security** و**Tools** بعد إزالة الوسوم الأقل دقة: Personal assistant وSelf-help وProductivity. كما تم تحسين افتتاحيات الوصف الكامل بالإنجليزية والعربية والفرنسية حول تنظيف الهاتف، اكتشاف الملفات المكررة، تحرير التخزين، وحماية الملفات الخاصة، مع إبقاء اسم التطبيق كما هو. حُفظت التغييرات كمسودة ولم يتم إرسالها للمراجعة.

اللغات الإضافية لم تُحذف. الأولوية التسويقية الحالية هي الإنجليزية والعربية والفرنسية، وسيتم تدقيق اللغات الأخرى قبل أي حذف حتى لا نفقد ظهورًا قائمًا. الصور وFeature Graphic والفيديو بقيت ضمن مسؤولية المالك للرفع اليدوي كما اتُّفق عليه.
