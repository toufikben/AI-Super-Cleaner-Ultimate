...
لا يستخدم التطبيق `QUERY_ALL_PACKAGES`. يحد Privacy Scanner من رؤية الحزم إلى التطبيقات التي تظهر للمستخدم في مشغل التطبيقات عبر عنصر `<queries>` محدد، ويفحص أذوناتها المطلوبة محليًا. ويستخدم `MANAGE_EXTERNAL_STORAGE` لأن وظائف إدارة وتنظيف الملفات تحتاج وصولًا واسعًا؛ يجب تقديم Permissions Declaration Form الخاصة به وإضافة إفصاح واضح داخل التطبيق ووصف المتجر.
